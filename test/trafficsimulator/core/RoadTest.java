...
public class RoadTest {
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a horizontal road is created and its direction is to the right, 
   * like this: ->   .
   */
  @Test
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a horizontal road is created and its direction is to the left, 
   * like this: <-   .
   */
  @Test
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a vertical road is created and its direction is to the up, 
   * like this: ^
   *            |  .
   */
  @Test
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a vertical road is created and its direction is to the right, 
   * like this: |
   *            v   .
   */
  @Test
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a road that has a downward slope is created and its direction is to the right, 
   * like this: \
   *             v .
   */
  @Test
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a road that has a downward slope is created and its direction is to the left, 
   * like this: /
   *           v    .
   */
  @Test
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a road that has an upward slope is created and its direction is to the right, 
   * like this:  ^
   *            /   .
   */
  @Test
  ...
  /**
   * This test checks if right parameters are calculated correctly if 
   * a road that has an upward slope is created and its direction is to the left, 
   * like this: ^
   *             \.
   */
  @Test
