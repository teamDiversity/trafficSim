...
public class LaneTest {  
  ...
  /**
   * This test checks if right and left parameters are calculated correctly if 
   * a horizontal road is created and its direction is to the right like this: -> 
  ...
  public void testLanesHorizontalRight() {
    ...
    */
    ...
    double expYRightStartLane2 = startLeft.getY() + lane1.laneWidth + lane2.laneWidth;
    ...
    double expYRightEndLane2 = endLeft.getY() + lane1.laneWidth + lane2.laneWidth;
